...
struct V2GameSessionTests {
    ...
    private func makeTestPuzzle() -> V2PuzzleData {
        V2PuzzleData(
            ...
            questions: [
                "q1": V2Question(id: "q1", text: "First question?", answer: "Yes", reveals: ["f2"], mechanism: "observation", prerequisites: [], correctAnswer: .yes, topicCategory: "cat1"),
                "q2": V2Question(id: "q2", text: "Second question?", answer: "Yes", reveals: ["f3"], mechanism: "link", prerequisites: [], correctAnswer: .yes, topicCategory: "cat1"),
            ],
