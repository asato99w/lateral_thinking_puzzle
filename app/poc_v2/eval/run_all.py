...
data_src.json の場合（_ フィールド検出で自動判別）:
  既存チェック + check_chain_consistency + check_hypothesis_chain
data.json の場合:
  既存チェックのみ
"""
...
from check_hypothesis_chain import run as run_hypothesis_chain
...
def main():
    ...
    if is_src and ok_integrity:
        ...
        ok_hypo, _ = run_hypothesis_chain(path)
        results.append(("check_hypothesis_chain", ok_hypo))
        print()
